...
from lane_detector.model import parsingNet
...
class UltraFastLaneDetector():
	...
	def __init__(self):
		...
		self.model_path = "artifact/tusimple_18.pth"
		self.cfg = ModelConfig(ModelType.TUSIMPLE)
		self.use_gpu = False

		# Initialize model
		self.lane_detection_model = self.initialize_model(
			self.model_path,
			self.cfg,
			self.use_gpu
		)
	...
	def draw_lanes(self, input_img, lanes_points, lanes_detected, draw_points=True):
